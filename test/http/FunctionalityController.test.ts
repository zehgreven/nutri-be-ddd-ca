...
describe('Functionality Controller', () => {
  ...
  describe('ListFunctionalities', () => {
    ...
    it('ListFunctionalities: should be able to list functionality and filter by name', async () => {
      const { status, body } = await global.testRequest
        .get('/functionalities/v1?page=1&limit=10&name=Início')
        .set({ Authorization: `Bearer ${token}` })
        .send();
    ...
    it('ListFunctionalities: should be able to list functionality and filter by description', async () => {
      const { status, body } = await global.testRequest
        .get('/functionalities/v1?page=1&limit=10&description=inicial')
        .set({ Authorization: `Bearer ${token}` })
        .send();
    ...
    it('ListFunctionalities: should be able to list functionality and filter by path', async () => {
      const { status, body } = await global.testRequest
        .get('/functionalities/v1?page=1&limit=10&path=%2Ffunctionality%2Fdetail')
        .set({ Authorization: `Bearer ${token}` })
        .send();
    ...
    it('ListFunctionalities: should be able to list functionality and filter by id', async () => {
      const { status, body } = await global.testRequest
        .get('/functionalities/v1?page=1&limit=10&id=8c29a940-463c-4670-914a-ef57cfb8cb3e')
        .set({ Authorization: `Bearer ${token}` })
        .send();
    ...
    it('ListFunctionalities: should be able to list functionality and filter by active', async () => {
      const { status, body } = await global.testRequest
        .get('/functionalities/v1?page=1&active=true')
        .set({ Authorization: `Bearer ${token}` })
        .send();

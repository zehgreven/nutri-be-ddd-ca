...
describe('ListFunctionalityTypeQuery', () => {
  ...
  it('ListFunctionalityTypeQuery: should be able to list functionality types and filter by description', async () => {
    const expectedArgs = {
      offset: 0,
      limit: 10,
      description: 'description',
  ...
  it('ListFunctionalityTypeQuery: should be able to list functionality types and filter by id', async () => {
    const expectedArgs = {
      offset: 0,
      limit: 10,
      id: '9e0140cc-f97f-4a88-a4d4-9bf98b7edc39',
  ...
  it('ListFunctionalityTypeQuery: should be able to list functionality types and filter by active', async () => {
    const expectedArgs = {
      offset: 0,
      limit: 10,
      active: true,
